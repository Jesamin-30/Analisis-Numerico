...
type
  TMethIntersection = class
    private
      MSP: TList;//lista de soluciones de bolzano, todos los xn
      nv: integer;//numero de iteraciones de bolzano
      //Top: Real;
    public
      MParse: TParseMath;
      constructor Create();
      ...
      function MBothIn(a,b,e: real; fn: string):       TRB;   //raiz en entre [a,b]
      function MBoth(xmin,xmax,e: real; fn,f: string): TList; //todas las raices en [xmin,xmax]
      function MPuntoFijo(a,e:real;fn:string):         TRB;
end;
...
function TMethIntersection.MPuntoFijo (a,e: real; fn: string): TRB;
var
  v,vt,et,h: real;
  MT: TList;
begin
...
function TMethIntersection.MBothIn(a,b,e: real; fn: string): TRB;
var
  xtmp: real;
begin
  xtmp:= MBisIni(a,b,0.01,fn);
  Result:= MSecant(xtmp,e,fn);
end;
